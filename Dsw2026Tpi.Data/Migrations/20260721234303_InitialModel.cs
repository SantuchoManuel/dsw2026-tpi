        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HoraDeEntrada = table.Column<TimeOnly>(type: "time", nullable: false),
                    HoraDeSalida = table.Column<TimeOnly>(type: "time", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HoraDeFin = table.Column<TimeOnly>(type: "time", nullable: false),
                    EstadoTurno = table.Column<int>(type: "int", nullable: false),
                    DisponibilidadId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
